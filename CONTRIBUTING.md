...
This document explains the processes and practices recommended for contributing enhancements to the Wazuh Dashboard Operator.

## Overview

- Generally, before developing enhancements to this charm, you should consider [opening an issue
  ](https://github.com/canonical/wazuh-dashboard-operator/issues) explaining your use case.
...
- [Fork](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks)
  our [GitHub repository](https://github.com/canonical/wazuh-dashboard-operator)
...
Canonical welcomes contributions to the Wazuh Dashboard Operator. Please check out our
...
```
git clone https://github.com/canonical/wazuh-dashboard-operator
```
...
OCI image for the Wazuh Dashboard app, and then upload the image to a MicroK8s registry,
...
# Deploy the charm
juju deploy ./wazuh-dashboard*.charm 
```
